...
ogdomainfile = open('official_test.csv')
newdomainfile = open('devstage_test.csv')
...
for igg in range(1278,1450):
        imagenumber = igg
        imga = rows1.index(rows1[imagenumber])
        ...
        data_folder6 = Path("predictions/location/images/")
        ...
        plt.savefig('coparisonimages/'+str(imga), bbox_inches='tight')
        # plt.show()
